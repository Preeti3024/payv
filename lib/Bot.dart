...
class _HomePageDialogflow extends State<HomePageDialogflow> {
  ...
  void speakmessage(String speakstring) async {
  ...
  void speecherror() {
    if (errorgiven == false) {
      ChatMessage message = new ChatMessage(
        text:
            "I didn't got that. Please Try Saying 'Pay'. OR Try saying 'Help' to get tutorial.",
        name: "Voice Coin",
        type: false,
      );
...
//  print("Query issssssssssssssss ="+query);
      ...
      Dialogflow dialogflow =
          Dialogflow(token: "4227dcdaaea44e15acfa93ceb8187657");
      ...
      if (response
          .getMessageResponse()
          .toString()
          .contains("Processing Payment of")) {
        String paymentResponse = response
            .getMessageResponse()
            .toString()
            .replaceAll("Processing Payment of", "");
        ...
        var tempupiid = (await database.rawQuery(
                'Select upiid from Upiuser where first_name = "$username"'))
            .toList()
            .toString();
